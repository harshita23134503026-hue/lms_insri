...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    const res = login(enrollmentNumber, password)
    if (res.success) {
  ...
  const inputClass =
    "w-full rounded-full border border-gray-200 bg-gray-50 px-5 py-3 pl-10 text-sm outline-none transition focus:border-yellow-400 focus:ring-2 focus:ring-yellow-300/40 placeholder:text-gray-400 text-gray-800"
        ...
        <div className="w-full lg:w-[48%] bg-white flex items-center justify-center px-8 py-12 lg:px-14">
          <div className="w-full max-w-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full bg-yellow-400 hover:bg-yellow-300 active:scale-[0.98] transition-all duration-200 py-3 rounded-full text-sm font-semibold text-gray-900"
              >
                Login
              </button>
            ...
            <div className="flex items-center gap-3 my-6">
              ...
              <span className="text-xs text-gray-300">or continue as</span>
              <div className="flex-1 h-px bg-gray-100" />
            </div>
            ...
            <div className="flex gap-2">
              {[
                ...
                <div
                  key={label}
                  className="flex-1 bg-gray-50 border border-gray-100 rounded-full py-2 flex items-center justify-center gap-1.5 text-xs text-gray-500 font-medium"
                >
